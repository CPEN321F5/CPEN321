...
public class ViewAdapterMyItem extends PagerAdapter
{
    ...
    private Drawable[] images = {MyItemActivity.drawable0, MyItemActivity.drawable1, MyItemActivity.drawable2};

    ViewAdapterMyItem(Context context)
    {
