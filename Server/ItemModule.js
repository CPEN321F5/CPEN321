...
Item_module.prototype.postItem = function(item){
    this.item_db.postItem(item).then(item_id => {
        console.log("inserted item with item id:")
        console.log(item_id)
    })
}
...
var Item2 = {
    "name" : "this is also a item but is hav a very very very very long name to decrease score",
    "Buyer" : "222",
    "Seller" : "333",
    "Description" : "none"
}
...
im.searchForItem("also").then(items => {
    console.log(items)
})
